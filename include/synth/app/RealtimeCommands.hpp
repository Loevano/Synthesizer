...
enum class RealtimeCommandType : std::uint8_t {
    ...
    TestWaveform,
    PiecesGrainSizeMs,
    PiecesGrainDensityHz,
    PiecesActiveGrains,
    PiecesPosition,
    PiecesPositionJitter,
    PiecesPitchSemitones,
    PiecesPitchJitterCents,
    PiecesOutputAlgorithm,
    PiecesOutputSpread,
    PiecesFeedbackAmount,
    PiecesFeedbackHighPassHz,
    PiecesFeedbackLowPassHz,
    RobinVoiceActive,
