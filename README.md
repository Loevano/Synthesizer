...
Fetch the latest `main` and build a fresh app:
...
the local checkout from `origin/main`, builds `build-app/Synthesizer.app`, and
copies the result to `Synthesizer.app` in the repo folder.
